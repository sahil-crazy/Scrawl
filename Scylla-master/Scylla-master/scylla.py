'''
Scrawl - The Information Gathering Engine
    Developed By: BatFam
...
'''
                                    NOTICE
The developer of this program, written the following code
...
'''
sms_api = ['64032a336b5aa5b2c3d095f2cc0c7e8e']
...
def main():
    ...
    if args.shodan_query == "webcamxp":
        ...
        try:
            ...
            cprint("\tExiting Scrawl...", 'red', attrs=['bold'])
            sys.exit(1)
